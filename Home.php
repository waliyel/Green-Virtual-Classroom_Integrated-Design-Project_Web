        ...
        <div class="container-fluid content-wrapper">
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    <a href="Course.php?courseID=<?php echo urlencode($row['courseID']); ?>
                        &courseCode=<?php echo urlencode($row['courseCode']); ?>
                        &section=<?php echo urlencode($row['section']); ?>
                        &name=<?php echo urlencode($name); ?>
                        &userID=<?php echo urlencode($userID); ?>
                        &profilePicture=<?php echo urlencode($profilePic); ?>
                        &role=<?php echo urlencode($role); ?>" class="text-decoration-none">
                        <div class="card h-100 course-tile">
                            <div class="card-header">
                                <?php echo htmlspecialchars($row['title']) . " (" . htmlspecialchars($row['semester']) . ") - Section: " . htmlspecialchars($row['section']); ?>
                            </div>
                            <div class="card-body">
                                <h5 class="card-title"><?php echo htmlspecialchars($row['teacher_name']); ?></h5>
